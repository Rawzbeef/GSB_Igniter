...
create table `INTERAGIR`(`MED_PERTURBATEUR` VARCHAR(10) not null,`MED_MED_PERTURBE` VARCHAR(10) not null,primary key(`MED_PERTURBATEUR`,`MED_MED_PERTURBE`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
create table `LABO`(`LAB_CODE` VARCHAR(2) not null,`LAB_NOM` VARCHAR(10),`LAB_CHEFVENTE` VARCHAR(20),primary key(`LAB_CODE`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
create table `MEDICAMENT`(`MED_DEPOTLEGAL` VARCHAR(10) not null,`MED_NOMCOMMERCIAL` VARCHAR(25),`FAM_CODE` VARCHAR(3) not null,`MED_COMPOSITION` VARCHAR(255),`MED_EFFETS` VARCHAR(255),`MED_CONTREINDIC` VARCHAR(255),`MED_PRIXECHANTILLON` FLOAT,primary key(`MED_DEPOTLEGAL`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
create table `OFFRIR`(`VIS_MATRICULE` VARCHAR(10) not null,`RAP_NUM` INT not null,`MED_DEPOTLEGAL` VARCHAR(10) not null,`OFF_QTE` SMALLINT,primary key(`VIS_MATRICULE`,`RAP_NUM`,`MED_DEPOTLEGAL`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
create table `POSSEDER`(`PRA_NUM` SMALLINT not null,`SPE_CODE` VARCHAR(5) not null,`POS_DIPLOME` VARCHAR(10),`POS_COEFPRESCRIPTION` FLOAT,primary key(`PRA_NUM`,`SPE_CODE`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
create table `SPECIALITE`(`SPE_CODE` VARCHAR(5) not null,`SPE_LIBELLE` VARCHAR(150),primary key(`SPE_CODE`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
create table `Switchboard Items`(`SwitchboardID` INT not null,`ItemNumber` SMALLINT not null,`ItemText` VARCHAR(255),`Command` SMALLINT,`Argument` VARCHAR(255),primary key(`SwitchboardID`,`ItemNumber`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
create table `ENGINE_INDIVIDU`(`TIN_CODE` VARCHAR(5) not null,`TIN_LIBELLE` VARCHAR(50),primary key(`TIN_CODE`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
create table `ENGINE_PRATICIEN`(`TYP_CODE` VARCHAR(3) not null,`TYP_LIBELLE` VARCHAR(25),`TYP_LIEU` VARCHAR(35),primary key(`TYP_CODE`)) ENGINE=INNODB DEFAULT CHARSET=utf8;
